...
const Course = () => {
  ...
  const plyrProps = {
    ...
    options: {
      ...
      autoplay: true,
      loop: true, // Set loop option to true if you want the video to loop
      keyboard: {
        focused: true,
        global: true,
      },
  ...
  return (
    <>
      <div className="flex flex-row gap-4 dark:bg-gray-950 dark:text-white transition-colors">
        <div className=" m-6 flex flex-col gap-4  font-kanit">
          <div className="flex flex-col gap-2">
            <div className="w-[560px] h-[350px] rounded-[35px] ml-[15px] ">
              <Plyr source={plyrProps.source} options={plyrProps.options} />
            </div>
            <div className=""></div>
          </div>
